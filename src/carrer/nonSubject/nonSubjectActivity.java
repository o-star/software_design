        ...
        try {
            ...
            while (condition) {
                ...
                if ((cell_workbook.getStringCellValue() + "").equals(user.getStudent_code()) == true) {
                    ...
                    this.examScore = Integer.parseInt(cell_student.getStringCellValue() + "");
                    ...
                    for(i=0; i<9; i++)
                    {
                        ...
                        {
                            XSSFCell cell_counseling = row_graduation.getCell(12);
                            essential_score = Integer.parseInt(cell_counseling.getStringCellValue()+"");
                        }
                    }
