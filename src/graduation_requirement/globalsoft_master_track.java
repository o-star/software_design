...
public class globalsoft_master_track extends global_software {
    ...
    public void setEnglish_grade(){
        ...
        super.english_grade = Double.parseDouble(super.setter(3, 1, 5));
    }
    public void setComplete_credit_amount(){
        /* 엑셀파일로부터 총 이수학점 setting */

        super.complete_credit_amount = Double.parseDouble(super.setter(3, 1, 0));
    }

    public void setMajor_credit() {
        /* 엑셀파일로부터 공학전공 이수학점 setting */

        major_credit = Double.parseDouble(super.setter(3, 1, 2));
    }

    public void setRefinement_credit() {
        /* 엑셀파일로부터 교양 이수학점 setting */

        refinement_credit = Double.parseDouble(super.setter(3, 1, 1));
    }
